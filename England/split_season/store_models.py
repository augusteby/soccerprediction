...
if __name__ == '__main__':
    ...
    for part_i in FILEPATHS:
        ...
        stder_file_name = 'validation/standardiser_part_' + str(part_i) + '.p'
        with open(stder_file_name, 'wb') as f:
            pickle.dump(standardizer, f)

        model_file_name = 'validation/model_part_' + str(part_i) + '.p'
        with open(model_file_name, 'wb') as f:
            pickle.dump(classifier, f)
            
        features_file_name = 'validation/features_part_' + str(part_i) + '.p'
