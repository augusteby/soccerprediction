...
FEAT_DIFF = ['diff_nb_victories', 'diff_nb_draws', 'diff_nb_defeats',
             'diff_nb_points', 'diff_nb_goals_diff', 'diff_season_wages']
...
FEAT_TO_KEEP_FOR_ML = (FEAT_HOME_TEAM + FEAT_AWAY_TEAM + FEAT_DIFF
...
def generate_all_season_games_features(one_season, data_wages_season,
    ...
    for index, row in one_season.iterrows():
        ...
        # compute differences between both teams
        one_season['diff_nb_victories'] = (one_season['h_nb_victories']
                                           - one_season['a_nb_victories'])
        one_season['diff_nb_draws'] = (one_season['h_nb_draws']
                                       - one_season['a_nb_draws'])
        one_season['diff_nb_defeats'] = (one_season['h_nb_defeats']
                                         - one_season['a_nb_defeats'])
        one_season['diff_nb_points'] = (one_season['h_nb_points']
                                        - one_season['a_nb_points'])
        one_season['diff_nb_goals_diff'] = (one_season['h_nb_goals_diff']
                                            - one_season['a_nb_goals_diff'])
        one_season['diff_season_wages'] = (one_season['h_season_wages']
                                           - one_season['a_season_wages'])
