...
if __name__=='__main__':
    ...
    if RDMF:
        classifier = RandomForestClassifier(n_estimators=100,max_features=0.2,min_samples_leaf=10)
    else:
        classifier = LogisticRegression(C=100)
    proba = cross_val_predict(classifier, X, y, method='predict_proba', cv=10)
