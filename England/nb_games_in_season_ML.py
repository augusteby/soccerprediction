...
if __name__ == '__main__':
    ...
    max_nb_games_played = int(np.max(data['h_nb_games'].values))
    ...
    for nb_games_played in nb_games_played_list:
        ...
        sub_data1 = data[data['h_nb_games'] >= nb_games_played]
        sub_data2 = data[data['h_nb_games'] == nb_games_played]
